...
//Helper class contains preset prompts for user to build their burger, and methods to receive valid inputs
public class Helper {

    public static Scanner scan = new Scanner(System.in);

    //Method to receive valid int input
    ...
    //Method to receive valid String input
